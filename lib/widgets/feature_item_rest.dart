...
class FeaturedItemRest extends StatefulWidget {
  // List Favourite
  final List<Item> items;

  final Item data;

  const FeaturedItemRest(
      {Key? key, this.onTap, required this.items, required this.data})
      : super(key: key);
  final GestureTapCallback? onTap;

  @override
  State<FeaturedItemRest> createState() => _FeaturedItemRestState();
}

class _FeaturedItemRestState extends State<FeaturedItemRest> {
